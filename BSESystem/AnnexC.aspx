<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AnnexC.aspx.vb" Inherits="BSESystem.AnnexC" %>
...
<body>
    ...
    <div>
        ...
        <h1 align="left">OUTSTANDING PAPERWORK - <em>FIRST REMINDER</em></h1>
        ...
        <table class="HeaderLayout">
            <tr>
                ...
                <td class="HeaderRight">
                    To: DVM
                    <br />
                    At: <asp:Label id="lblAHOName" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
        ...
        <table class="InformationTable">
            <tr class="InformationTableHeader">
                <td rowspan="2" class="InformationTableCell">RBSE No</td>
                <td rowspan="2" class="InformationTableCell">Outstanding BSE Forms</td>
                ...
                <td rowspan="2" class="InformationTableCell">Who will be carrying out the tracing</td>
            </tr>
            <tr class="InformationTableHeader">
            ...
            <asp:Repeater id="rptRepeater" runat="server">
                <ItemTemplate>
                    <tr>
                        <td class="InformationTableCell"><asp:label id="lblRBSE" runat="server" Text=<%# DataBinder.Eval(Container.DataItem, "RBSE") %>></asp:label></td>
