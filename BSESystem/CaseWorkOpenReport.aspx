<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CaseWorkOpenReport.aspx.vb" Inherits="BSESystem.CaseWorkOpenReport" %>
...
<head id="Head1" runat="server">
    <title>BSE System : Open Cases</title>
...
<body>
    ...
    <asp:HyperLink id="hlCaseworkClosedReportLink" runat="server" Text="See closed cases" NavigateUrl="CaseWorkClosedReport.aspx"></asp:HyperLink>
    <asp:datagrid id="grdCases" runat="server"  AutoGenerateColumns="False" AllowSorting="True">
		...
		<Columns>
			...
			<asp:TemplateColumn SortExpression="ActiveMemoDueDate" HeaderText="Active Memo Due">
			    <ItemTemplate>
							<asp:Label id="lblActiveMemoDueDateDisplay" runat="server"></asp:Label>
				</ItemTemplate>
			</asp:TemplateColumn>
			...
			<asp:TemplateColumn SortExpression="AnnexADueDate" HeaderText="Annex A Due">
			    <ItemTemplate>
							<asp:Label id="lblAnnexADueDateDisplay" runat="server"></asp:Label>
				</ItemTemplate>
			</asp:TemplateColumn>
			...
			<asp:TemplateColumn SortExpression="AnnexBDueDate" HeaderText="Annex B Due">
			    <ItemTemplate>
							<asp:Label id="lblAnnexBDueDateDisplay" runat="server"></asp:Label>
				</ItemTemplate>
			</asp:TemplateColumn>
			...
			<asp:TemplateColumn SortExpression="AnnexCDueDate" HeaderText="Annex C Due">
			    <ItemTemplate>
							<asp:Label id="lblAnnexCDueDateDisplay" runat="server"></asp:Label>
				</ItemTemplate>
			</asp:TemplateColumn>
			...
			<asp:TemplateColumn SortExpression="AnnexDDueDate" HeaderText="Annex D Due">
			    <ItemTemplate>
							<asp:Label id="lblAnnexDDueDateDisplay" runat="server"></asp:Label>
				</ItemTemplate>
			</asp:TemplateColumn>
			...
			<asp:TemplateColumn SortExpression="LabChaseDueDate" HeaderText="Lab Chase Due Date">
			    <ItemTemplate>
							<asp:Label id="lblLabChaseDueDateDisplay" runat="server"></asp:Label>
				</ItemTemplate>
			</asp:TemplateColumn>
			...
			<asp:TemplateColumn SortExpression="BarbMemoDue" HeaderText="Barb Memo Due">
			    <ItemTemplate>
							<asp:Checkbox id="chkBarbMemoDueDisplay" Enabled=false runat="server"></asp:Checkbox>
				</ItemTemplate>
			</asp:TemplateColumn>
	...
	<div style="WIDTH: 750px; POSITION: relative; HEIGHT: 28px" ms_positioning="GridLayout">
		<P><uc1:datagridpager id="Pager" runat="server" Visible="false"></uc1:datagridpager></P>
	</div>
    <P>
