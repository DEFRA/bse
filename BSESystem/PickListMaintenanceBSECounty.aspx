...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PickListMaintenanceBSECounty.aspx.vb" Inherits="BSESystem.PickListMaintenanceBSECounty"%>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<DIV style="WIDTH: 759px; POSITION: relative; HEIGHT: 96px" ms_positioning="GridLayout">
			...
			<P>
				<asp:datagrid id="grdLookup" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="IDColumn" SortExpression="IDColumn" HeaderText="ID">
						...
						<asp:TemplateColumn SortExpression="BSERegionID" HeaderText="BSE Region">
							...
							<EditItemTemplate>
								<asp:DropDownList id=ddlBSERegionEdit runat="server" DataSource="<%# GetBSERegionList %>" DataTextField="Name" DataValueField="ID">
								</asp:DropDownList>
							</EditItemTemplate>
						</asp:TemplateColumn>
					</Columns>
