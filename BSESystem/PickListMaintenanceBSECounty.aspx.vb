Partial Class PickListMaintenanceBSECounty
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            LoadLookupLists()
            SelectItemInDropDownList(ddlEditableLookups, LOOKUP_BSE_COUNTY)
            RefreshLookupGrid()
        End If
        EnableControls()
    End Sub
...
#Region "Event handlers"
    ...
    Private Sub grdLookup_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles grdLookup.ItemDataBound
        Try
            ...
            If Not drv Is Nothing Then
                Dim lblBSERegion As Label = Nothing
                Dim ddlBSERegion As DropDownList = Nothing

                If e.Item.ItemType = ListItemType.EditItem Then
                    ' populate edit mode controls
                    ddlBSERegion = CType(e.Item.FindControl("ddlBSERegionEdit"), DropDownList)
                ...
                OrElse e.Item.ItemType = ListItemType.SelectedItem Then
                    ...
                    lblBSERegion = CType(e.Item.FindControl("lblBSERegionDisplay"), Label)
                End If

                If Not lblBSERegion Is Nothing Then
                    If Not IsDBNull(drv("BSERegionID")) Then
                        lblBSERegion.Text = GetBSERegion(drv("BSERegionID"))
                    Else
                        lblBSERegion.Text = ""
                    End If
                End If

                If Not ddlBSERegion Is Nothing Then
                    If Not IsDBNull(drv("BSERegionID")) Then
                        SelectItemInDropDownList(ddlBSERegion, drv("BSERegionID"))
                    End If
                End If
            End If
    ...
    Private Sub Pager_RowSave(ByVal sender As Object, ByVal e As BSESystem.DataGridPagerEventArgs) Handles Pager.RowSave
        ...
        Dim lst As DropDownList = CType(e.GridRow.FindControl("ddlBSERegionEdit"), DropDownList)
        e.DataTableRow("BSERegionID") = lst.SelectedItem.Value
...
#Region "Private functions"
    ...
    Private Function GetBSERegion(ByVal sCode As String) As String

        Try
            Dim dt As DataTable = GetBSERegionList()
    ...
    Public Function GetBSERegionList() As DataTable
        Try
            Dim objLookup As New BSELib.LookupData()
            Dim dt As DataTable = objLookup.GetBSERegionID()

            If dt Is Nothing Then
                Throw New Exception("LookupData.GetBSERegionID returned Nothing")
            End If
