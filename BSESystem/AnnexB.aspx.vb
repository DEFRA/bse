Public Partial Class AnnexB
    ...
    Private Sub Headers()
        ...
        Else
            With Response
                ...
                .AddHeader("Content-Disposition", "attachment; filename=""annexb" & sRBSE & ".doc""")
            End With
        End If
    ...
    Private Function LoadCaseDetails() As Boolean
        Try
            ...
            If Not (objCase.GetMinuteDetails(sRBSE, "AnnexB", dtData)) Then
            ...
            If dtData.Rows.Count <> 0 Then
                With dtData.Rows(0)
                    ...
                    lblDate.Text = FormatDate(.Item("AnnexBDate").ToString())
                    lblAHOName1.Text = .Item("AHOName").ToString()
                    lblAHOName2.Text = .Item("AHOName").ToString()
                    lblAnnexADate.Text = FormatDate(.Item("AnnexADate").ToString())
                End With
