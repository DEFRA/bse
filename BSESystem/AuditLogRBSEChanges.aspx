...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AuditLogRBSEChanges.aspx.vb" Inherits="BSESystem.AuditLogRBSEChanges" %>
...
<HTML>
	<HEAD>
		<title>BSE System : RBSE Changes Audit Log Report</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<DIV style="WIDTH: 750px; POSITION: relative; HEIGHT: 88px" ms_positioning="GridLayout">
				...
				<P></P>
				<HR style="Z-INDEX: 106; LEFT: 16px; WIDTH: 96.14%; POSITION: absolute; TOP: 80px; HEIGHT: 1px" width="96.14%" SIZE="1">
