<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PickListMaintenanceBreed.aspx.vb" Inherits="BSESystem.PickListMaintenanceBreed"%>
			...
			<P>
				<asp:datagrid id="grdLookup" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="AmalgamatedName" SortExpression="AmalgamatedName" HeaderText="Amalgamated Name">
							<HeaderStyle Width="250px"></HeaderStyle>
						</asp:BoundColumn>
					</Columns>
