...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PickListMaintenanceSupplier.aspx.vb" Inherits="BSESystem.PickListMaintenanceSupplier"%>
			...
			<P>
				<asp:datagrid id="grdLookup" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="Details" SortExpression="Details" HeaderText="Details">
							<HeaderStyle Width="250px"></HeaderStyle>
						</asp:BoundColumn>
					</Columns>
