...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AuditLogCaseMoves.aspx.vb" Inherits="BSESystem.AuditLogCaseMoves" %>
...
<HTML>
	<HEAD>
		<title>BSE System : Case Moves Audit Log Report</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="grdResults" runat="server" Width="568px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False">
				...
				<Columns>
					<asp:BoundColumn DataField="TableName" SortExpression="TableName" ReadOnly="True" HeaderText="Table" DataFormatString="{0:G}"></asp:BoundColumn>
					...
					<asp:BoundColumn DataField="HasBatches" SortExpression="HasBatches" HeaderText="Recorded in batch?"></asp:BoundColumn>
				</Columns>
