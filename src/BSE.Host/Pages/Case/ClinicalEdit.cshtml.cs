...
public class ClinicalEditModel(
    ...
    IConfiguration configuration) : PageModel
{
    ...
    private async Task LoadAsync()
    {
        ...
        await Task.WhenAll(clinicalTask, batchTask);
    ...
    public class ClinicalSignsViewModel
    {
        ...
        public static ClinicalSignsViewModel FromRecord(CaseClinicalRecord r) => new()
        {
            ...
            HeadShyness          = r.HeadShyness,          LickingFlank         = r.LickingFlank,
            LickingNose          = r.LickingNose,          Kicking              = r.Kicking,
            ReluctantDoorways    = r.ReluctantDoorways,    HeadPressing         = r.HeadPressing,
            HeadRubbing          = r.HeadRubbing,          TeethGrinding        = r.TeethGrinding,
            Blindness            = r.Blindness,            Circling             = r.Circling,
            HindAtaxia           = r.HindAtaxia,           Falling              = r.Falling,
            Paresis              = r.Paresis,               ForeAtaxia           = r.ForeAtaxia,
            Recumbent            = r.Recumbent,            Tremor               = r.Tremor,
        ...
        public AddCaseClinicalCommand ToAddCommand(string rbse) => new(
            rbse,
            Apprehension, HypersensitiveTouch, HypersensitiveSound, Maniacal, PanicStricken,
            TemperamentChange, AbnormalHeadCarriage, EarTwitching, EarsOddAngle, AbnormalBehaviour,
            HeadShyness, LickingFlank, LickingNose, Kicking, ReluctantDoorways,
            HeadPressing, HeadRubbing, TeethGrinding, Blindness, Circling,
            HindAtaxia, Falling, Paresis, ForeAtaxia, Recumbent, Tremor,
            KnucklingFetlock, WeightLoss, ConditionLoss, MilkYield);
        ...
        public EditCaseClinicalCommand ToEditCommand(string rbse, byte[] rowStamp) => new(
            ...
            HeadPressing, HeadRubbing, TeethGrinding, Blindness, Circling,
            HindAtaxia, Falling, Paresis, ForeAtaxia, Recumbent, Tremor,
            KnucklingFetlock, WeightLoss, ConditionLoss, MilkYield, rowStamp);
    }
}
